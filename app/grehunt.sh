                         ...
                         if [ "$1" == "--example" ]; then
                            ...
                            if [ "$1" == "--usage" ]; then
                                ...
                                if [ "$1" == "--antonyms" ]; then
                                    ...
                                    arg5="${1// /_}"
                                    shift
                                    python3 -m app.app --append $arg1 --speech $speech --meaning $arg2 --example $arg3 --usage $arg4 --antonyms $arg5
                                else

                                    if [ $# -gt 0 ]; then
                                        append_usage
                                    fi
                                    python3 -m app.app --append $arg1 --speech $speech --meaning $arg2 --example $arg3 --usage $arg4
                                fi
                             else
                                 python3 -m app.app --append $arg1 --speech $speech --meaning $arg2 --example $arg3
                            fi

                         else
                            python3 -m app.app --append $arg1 --speech $speech --meaning $arg2
                         fi
                         ;;
